...
var INSTAGRAM_TEMPLATE = '<a href="\{\{link\}\}" target="_blank"><img class="size-info" width="320" height="320" src="\{\{image\}\}" alt="Instagram"></a><div class="info pa tc flex ts__03 center-xs middle-xs"><span class="likes"><i class="fa fa-heart-o"></i>\{\{likes\}\}</span><span class="comments"><i class="fa fa-comments-o"></i>\{\{comments\}\}</span></div>';
